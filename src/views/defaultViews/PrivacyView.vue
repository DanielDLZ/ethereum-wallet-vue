<template>
  <div class="max-w-screen-lg m-auto px-6 my-16 md:px-0">
    <div class="space-y-6">
      ...
      <p>
        Daniel built the Ethereum wallet app as an Open Source app. This SERVICE
        is provided by Daniel at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Ethereum wallet unless
      ...
      <p>
        ...
        but not limited to Tatata, papap, lallala. The information that I
      ...
      <p>This policy is effective as of 2022-09-06</p>
      <p><strong>Contact Us</strong></p>
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at lorem@ether.com.
      </p>
      <p>
