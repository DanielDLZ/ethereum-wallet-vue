<template>
  <div class="max-w-screen-lg m-auto my-16 px-6 space-y-6 md:px-0">
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Daniel.
    </p>
    <p>
      Daniel is committed to ensuring that the app is as useful and efficient as
    ...
    <p>
      The Ethereum wallet app stores and processes personal data that you have
      ...
      features and it could mean that the Ethereum wallet app won’t work
      properly or at all.
    </p>
    <!---->
    <p>
      You should be aware that there are certain things that Daniel will not
      ...
      provided by your mobile network provider, but Daniel cannot take
    ...
    <p>
      Along the same lines, Daniel cannot always take responsibility for the way
      ...
      Daniel cannot accept responsibility.
    </p>
    <p>
      With respect to Daniel’s responsibility for your use of the app, when
      ...
      available to you. Daniel accepts no liability for any loss, direct or
      indirect, you experience as a result of relying wholly on this
      functionality of the app.
    </p>
    <p>
      At some point, we may wish to update the app. The app is currently
      available on iOS – the requirements for the system(and for any additional
      ...
      Daniel does not promise that it will always update the app so that it is
      relevant to you and/or works with the iOS version that you have installed
    ...
    <p>These terms and conditions are effective as of 2022-09-06</p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about my Terms and Conditions, do
      not hesitate to contact me at lorem@ether.com.
    </p>
    <p>
